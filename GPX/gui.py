...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.FieldRole, self.txtOutputDir)
        ...
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.FieldRole, self.txtOutputFile)
        ...
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.SpanningRole, self.prgbarAvancement)
        ...
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.SpanningRole, self.txtOutputPy)
        self.chkLocation = QtGui.QCheckBox(self.grpOutput)
        self.chkLocation.setChecked(True)
        self.chkLocation.setObjectName(_fromUtf8("chkLocation"))
        self.formLayout_2.setWidget(0, QtGui.QFormLayout.LabelRole, self.chkLocation)
        self.chkEquipments = QtGui.QCheckBox(self.grpOutput)
        self.chkEquipments.setChecked(True)
        self.chkEquipments.setObjectName(_fromUtf8("chkEquipments"))
        self.formLayout_2.setWidget(0, QtGui.QFormLayout.FieldRole, self.chkEquipments)
        ...
        self.btnUpdateDates = QtGui.QPushButton(self.grpInput)
        self.btnUpdateDates.setObjectName(_fromUtf8("btnUpdateDates"))
        self.gridLayout_2.addWidget(self.btnUpdateDates, 3, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnUpdateDates.setText(_translate("MainWindow", "Mise à jour de l\'intervalle", None))
