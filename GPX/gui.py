...
#
# Created: Thu Nov  3 08:14:42 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.grpOutput, 1, 0, 1, 3)
        self.grpInput = QtGui.QGroupBox(self.centralwidget)
        self.grpInput.setObjectName(_fromUtf8("grpInput"))
        self.formLayout = QtGui.QFormLayout(self.grpInput)
        ...
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.lblInputDir)
        self.txtInputDir = QtGui.QLineEdit(self.grpInput)
        self.txtInputDir.setObjectName(_fromUtf8("txtInputDir"))
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.txtInputDir)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.dateFrom)
        ...
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.dateTo)
